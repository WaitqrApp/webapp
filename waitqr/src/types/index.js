...
export const NOMBREETIQUETAS_PLATILLO = "NOMBREETIQUETAS_PLATILLO";
export const AGREGAR_NOMBREETIQUETA = "AGREGAR_NOMBREETIQUETA";
export const VALIDAR_NOMBREETIQUETA = "VALIDAR_NOMBREETIQUETA";
export const ELIMINAR_NOMBREETIQUETA = "ELIMINAR_NOMBREETIQUETA";
export const ESTADO_NOMBREETIQUETA = "ESTADO_NOMBREETIQUETA";
export const NOMBREETIQUETA_ACTUAL = "NOMBREETIQUETA_ACTUAL";
export const ACTUALIZAR_NOMBREETIQUETA = "ACTUALIZAR_NOMBREETIQUETA";
export const LIMPIAR_NOMBREETIQUETA = "LIMPIAR_NOMBREETIQUETA";

export const ETIQUETAS_NOMBREETIQUETA = "ETIQUETAS_NOMBREETIQUETA";
export const AGREGAR_ETIQUETA = "AGREGAR_ETIQUETA";
export const VALIDAR_ETIQUETA = "VALIDAR_ETIQUETA";
export const ELIMINAR_ETIQUETA = "ELIMINAR_ETIQUETA";
export const ESTADO_ETIQUETA = "ESTADO_ETIQUETA";
export const ETIQUETA_ACTUAL = "ETIQUETA_ACTUAL";
export const ACTUALIZAR_ETIQUETA = "ACTUALIZAR_ETIQUETA";
export const LIMPIAR_ETIQUETA = "LIMPIAR_ETIQUETA";

export const PLATILLOS_SECCION = "PLATILLOS_SECCION";
export const PLATILLOS_RESTAURANTE = "PLATILLOS_RESTAURANTE";
