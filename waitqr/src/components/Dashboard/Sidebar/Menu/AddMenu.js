...
function AddMenu(props) {
  ...
  const { menuseleccionado, errormenu, agregarMenu, validarMenu, obtenerMenus,
    actualizarMenu, limpiarMenu } = menussContext;
  ...
  return (
    <Modal {...props} aria-labelledby="contained-modal-title-vcenter">
      ...
      >
          ...
          <Container>
            ...
            <Form.Group as={Row} controlId="formHorizontalPassword">
              ...
              <Col sm={9}>
                <Form.Control
                  type="text"
                  placeholder="Horario inicio del Menu"
                  name="horarioInicio"
                  value={horarioInicio}
                  onChange={handleChange}
                />
            ...
            <Form.Group as={Row} controlId="formHorizontalPassword">
              ...
              <Col sm={9}>
                <Form.Control
                  type="text"
                  placeholder="Horario Final del Menu"
                  name="horarioFin"
                  value={horarioFin}
                  onChange={handleChange}
                />
        ...
        <Modal.Footer>
          <Button type="submit" onClick={props.onHide}>Agregar Menu</Button>
        </Modal.Footer>
      </Form>
    </Modal>
  );
